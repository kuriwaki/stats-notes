...
\begin{example}
Consider two random variables $X$ and $Y$, each of them independently distributed Bernoulli($p$). What is $P(X = 1, Y = 1)$ 
\end{example}

\begin{solution}
Because they are independent, $P(X = 1, Y =1) = P(X = 1)P(Y= 1)$ which is $p^2$.
\end{solution}
